...
//                System.out.println("EEEEEEEEEEEEEEEEstate" + newsList);
    ...
    public List<NewsDto> getglobaleconomyNews() throws IOException {
        System.out.println("NewsService getNews executed");

        String redisKey = "globaleconomynews";
        List<NewsDto> newsList5 = redisService.getNewsData(redisKey);

        if (newsList5 == null || newsList5.isEmpty()) {
            System.out.println("No data in Redis. API call.");
            newsList5 = new ArrayList<>();
            String url = "https://news.naver.com/breakingnews/section/101/262";
            Document doc = Jsoup.connect(url).get();
            ...
            for (Element newsElement : newsElements) {
                ...
                newsList5.add(newsDto);
//                System.out.println("EEEEEEEEEEEEEEEEstate" + newsList);
            }
            redisService.setData(redisKey, newsList5, 5);
        }
        return newsList5;
    }

    public List<NewsDto> geteconomyNews() throws IOException {
        System.out.println("NewsService getNews executed");

        String redisKey = "economynews";
        List<NewsDto> newsList6 = redisService.getNewsData(redisKey);

        if (newsList6 == null || newsList6.isEmpty()) {
            System.out.println("No data in Redis. API call.");
            newsList6 = new ArrayList<>();
            String url = "https://news.naver.com/breakingnews/section/101/263";
            Document doc = Jsoup.connect(url).get();
            ...
            for (Element newsElement : newsElements) {
                ...
                newsList6.add(newsDto);
//                System.out.println("EEEEEEEEEEEEEEEEstate" + newsList);
            }
            redisService.setData(redisKey, newsList6, 5);
        }
        return newsList6;
    }
}
